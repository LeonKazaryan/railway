...
function fluctuate(prev: TelemetrySnapshot): TelemetrySnapshot {
  ...
  return {
    ...
    brake_pipe_pressure_kpa: clamp(
      jitter(prev.brake_pipe_pressure_kpa, 5),
      0,
      800,
    ),
    main_reservoir_pressure_kpa: clamp(
      jitter(prev.main_reservoir_pressure_kpa, 4),
      0,
      1100,
    ),
    brake_cylinder_pressure_kpa: clamp(
      jitter(prev.brake_cylinder_pressure_kpa, 3),
      0,
      400,
    ),
    brake_pipe_leak_kpa_per_min: clamp(
      jitter(prev.brake_pipe_leak_kpa_per_min, 0.05),
      0,
      5,
    ),
