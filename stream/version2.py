...
LINES_CONFIG: list[dict] = [
    {
        ...
        "waypoints": [
            ...
            {"name": "Karaganda", "lat": 49.7926276, "lon": 72.8053229, "alt_m": 500},
        ...
        "geofences": [
            {"name": "astana_station", "type": "station", "lat": 51.1954259, "lon": 71.391907, "radius_m": 5000},
            {"name": "karaganda_station", "type": "station", "lat": 49.7926276, "lon": 72.8053229, "radius_m": 5000},
            {"name": "balkhash_station", "type": "station", "lat": 46.8609, "lon": 74.8976911, "radius_m": 4000},
            {"name": "shu_station", "type": "station", "lat": 43.6014393, "lon": 73.7603113, "radius_m": 5000},
            {"name": "sz_astana_shu_1", "type": "slow_zone", "lat": 48.3, "lon": 73.9, "radius_m": 15000, "rules": {"speed_limit_kph": 40}},
            {"name": "sz_astana_shu_2", "type": "slow_zone", "lat": 44.8, "lon": 74.1, "radius_m": 12000, "rules": {"speed_limit_kph": 35}},
        ],
        "base_serial": 100,
        "base_train": 1000,
    },
    {
        ...
        "waypoints": [
            ...
            {"name": "Shymkent", "lat": 42.3170027, "lon": 69.5795664, "alt_m": 500},
        ...
        "geofences": [
            {"name": "arys_station", "type": "station", "lat": 42.4287345, "lon": 68.7827391, "radius_m": 5000},
            {"name": "shymkent_station", "type": "station", "lat": 42.3170027, "lon": 69.5795664, "radius_m": 5000},
            {"name": "taraz_station", "type": "station", "lat": 42.8700107, "lon": 71.3761308, "radius_m": 5000},
            {"name": "almaty_turksib_station", "type": "station", "lat": 43.2737785, "lon": 76.934677, "radius_m": 6000},
            {"name": "sz_turksib_1", "type": "slow_zone", "lat": 43.05, "lon": 74.0, "radius_m": 12000, "rules": {"speed_limit_kph": 35}},
        ],
        "base_serial": 200,
        "base_train": 2000,
    },
    {
        ...
        "waypoints": [
            ...
            {"name": "Aralsk", "lat": 46.8009486, "lon": 61.6750584, "alt_m": 65},
            {"name": "Kyzylorda", "lat": 44.8544669, "lon": 65.4926015, "alt_m": 130},
            {"name": "Turkestan", "lat": 43.2859281, "lon": 68.2132103, "alt_m": 210},
            {"name": "Arys", "lat": 42.4287345, "lon": 68.7827391, "alt_m": 300},
        ],
        "speed_limits": [
        ...
        "geofences": [
            {"name": "aktobe_station", "type": "station", "lat": 50.281139, "lon": 57.211977, "radius_m": 5000},
            {"name": "aralsk_station", "type": "station", "lat": 46.8009486, "lon": 61.6750584, "radius_m": 4000},
            {"name": "kyzylorda_station", "type": "station", "lat": 44.8544669, "lon": 65.4926015, "radius_m": 5000},
            {"name": "turkestan_station", "type": "station", "lat": 43.2859281, "lon": 68.2132103, "radius_m": 4000},
            {"name": "arys_ta_station", "type": "station", "lat": 42.4287345, "lon": 68.7827391, "radius_m": 5000},
            {"name": "sz_transaral_1", "type": "slow_zone", "lat": 45.8, "lon": 63.5, "radius_m": 14000, "rules": {"speed_limit_kph": 40}},
        ],
        "base_serial": 300,
        "base_train": 3000,
    },
    {
        ...
        "waypoints": [
            {"name": "Almaty", "lat": 43.2737785, "lon": 76.934677, "alt_m": 800},
            {"name": "Aktogay", "lat": 46.9533818, "lon": 79.6815207, "alt_m": 600},
        ...
        "geofences": [
            {"name": "almaty_ad_station", "type": "station", "lat": 43.2737785, "lon": 76.934677, "radius_m": 6000},
            {"name": "aktogay_station", "type": "station", "lat": 46.9533818, "lon": 79.6815207, "radius_m": 4000},
            {"name": "dostyk_station", "type": "station", "lat": 45.2619021, "lon": 82.465803, "radius_m": 5000},
            {"name": "sz_dostyk_1", "type": "slow_zone", "lat": 46.1, "lon": 81.0, "radius_m": 13000, "rules": {"speed_limit_kph": 35}},
        ],
        "base_serial": 400,
        "base_train": 4000,
    },
    ...
    def __init__(self, cfg: dict) -> None:
        ...
        for g in cfg["geofences"]:
            self.geofences.append(
                GeofenceModel(
                    geofence_id=str(uuid.uuid5(uuid.NAMESPACE_DNS, f"{self.line_id}:{g['name']}")),
                    name=g["name"],
                    type=g["type"],
                    center_lat=g["lat"],
                    center_lon=g["lon"],
...
class RouteEngine:
    def __init__(self, line: RailwayLine, segment_index: int = 0, segment_progress: float = 0.0, direction: str = "forward") -> None:
        self.line = line
    ...
    def _wp_start(self) -> dict:
        return self.line.waypoints_data[self.segment_index] if self.direction == "forward" else self.line.waypoints_data[self.segment_index + 1]

    def _wp_end(self) -> dict:
        return self.line.waypoints_data[self.segment_index + 1] if self.direction == "forward" else self.line.waypoints_data[self.segment_index]
    ...
    def _interpolate(self) -> None:
        ...
        self.distance_to_next_wp_km = haversine(self.lat, self.lon, we["lat"], we["lon"]) / 1000.0
    ...
    def _update_geofences(self) -> None:
        ...
        self.active_geofences = [
            gf for gf in self.line.geofences
            if haversine(self.lat, self.lon, gf.center_lat, gf.center_lon) <= gf.radius_m
        ]
    ...
    def approaching_station(self, threshold_m: float = 12000.0) -> bool:
        ...
        return any(gf.type == "station" and name_lower in gf.name for gf in self.line.geofences)
...
ALERT_RULES: list[dict] = [
    {"metric": "brake_pipe_pressure_kpa", "op": "<", "threshold": 380, "severity": "warning", "code": "BRK_PIPE_WARN", "family": "brake_pipe", "msg": "Brake pipe pressure low: {value:.0f} kPa"},
    {"metric": "brake_pipe_pressure_kpa", "op": "<", "threshold": 310, "severity": "critical", "code": "BRK_PIPE_CRIT", "family": "brake_pipe", "msg": "Brake pipe pressure critical: {value:.0f} kPa"},
    {"metric": "brake_pipe_pressure_kpa", "op": "<", "threshold": 90, "severity": "critical", "code": "BRK_PIPE_EMER", "family": "brake_pipe", "msg": "Brake pipe pressure emergency: {value:.0f} kPa"},
    {"metric": "main_reservoir_pressure_kpa", "op": "<", "threshold": 414, "severity": "critical", "code": "MAIN_RES_CRIT", "family": "main_reservoir", "msg": "Main reservoir pressure low: {value:.0f} kPa"},
    {"metric": "engine_rpm", "op": ">", "threshold": 1050, "severity": "critical", "code": "RPM_OVER", "family": "engine_rpm", "msg": "Engine RPM critical: {value:.0f}"},
    {"metric": "engine_temp_c", "op": ">", "threshold": 100, "severity": "warning", "code": "ENG_TEMP_WARN", "family": "engine_temp", "msg": "Engine temperature high: {value:.1f}°C"},
    {"metric": "engine_temp_c", "op": ">", "threshold": 110, "severity": "critical", "code": "ENG_TEMP_CRIT", "family": "engine_temp", "msg": "Engine temperature critical: {value:.1f}°C"},
    {"metric": "oil_temp_c", "op": ">", "threshold": 105, "severity": "warning", "code": "OIL_TEMP_WARN", "family": "oil_temp", "msg": "Oil temperature high: {value:.1f}°C"},
    {"metric": "oil_temp_c", "op": ">", "threshold": 110, "severity": "critical", "code": "OIL_TEMP_CRIT", "family": "oil_temp", "msg": "Oil temperature critical: {value:.1f}°C"},
    {"metric": "brake_pipe_leak_kpa_per_min", "op": ">", "threshold": 25, "severity": "warning", "code": "LEAK_WARN", "family": "brake_leak", "msg": "Brake pipe leak rate high: {value:.1f} kPa/min"},
    {"metric": "brake_pipe_leak_kpa_per_min", "op": ">", "threshold": 34.5, "severity": "critical", "code": "LEAK_CRIT", "family": "brake_leak", "msg": "Brake pipe leak rate critical: {value:.1f} kPa/min"},
    {"metric": "alerter_timer_sec", "op": ">", "threshold": 20, "severity": "warning", "code": "ALERTER_WARN", "family": "alerter", "msg": "Alerter timeout warning: {value:.1f}s"},
    {"metric": "alerter_timer_sec", "op": ">", "threshold": 25, "severity": "critical", "code": "ALERTER_CRIT", "family": "alerter", "msg": "Alerter timeout critical: {value:.1f}s"},
    {"metric": "eab_status", "op": "==", "threshold": "degraded", "severity": "warning", "code": "EAB_DEGRADED", "family": "eab", "msg": "EAB system degraded"},
    {"metric": "eab_status", "op": "==", "threshold": "lost", "severity": "critical", "code": "EAB_LOST", "family": "eab", "msg": "EAB system lost"},
    {"metric": "comm_state", "op": "==", "threshold": "intermittent", "severity": "warning", "code": "COMM_INTERMIT", "family": "comm", "msg": "Communications intermittent"},
    {"metric": "comm_state", "op": "==", "threshold": "offline", "severity": "critical", "code": "COMM_OFFLINE", "family": "comm", "msg": "Communications offline"},
    {"metric": "health_index", "op": "<=", "threshold": 70, "severity": "warning", "code": "HEALTH_WARN", "family": "health", "msg": "Health index degraded: {value}"},
    {"metric": "health_index", "op": "<", "threshold": 40, "severity": "critical", "code": "HEALTH_CRIT", "family": "health", "msg": "Health index critical: {value}"},
]
...
class AlertEngine:
    ...
    def evaluate(self, state: dict, event_log: collections.deque) -> tuple[str, list[str]]:
        ...
        for fam in all_families:
            ...
            if new and new != old:
                ...
                if rule:
                    try:
                        msg = rule["msg"].format(value=state.get(rule["metric"], 0))
                    except Exception:
                        msg = rule["msg"]
                event_log.append(EventLogEntry(
                    event_id=str(uuid.uuid4()), ts=utcnow_iso(),
                    locomotive_id=self.locomotive_id, line_id=self.line_id,
                    severity=sev, event_type="alert", code=code, message=msg,
                ).model_dump())
                ...
                event_log.append(EventLogEntry(
                    event_id=str(uuid.uuid4()), ts=utcnow_iso(),
                    locomotive_id=self.locomotive_id, line_id=self.line_id,
                    severity="info", event_type="alert", code="ALERT_RESOLVED",
...
_ANOMALY_TYPES = [
    "brake_pressure_drift", "leak_rate_increase", "engine_overtemp",
    "comm_degradation", "alerter_timeout", "eab_degradation",
]


class _AnomalySlot:
    __slots__ = ("atype", "severity", "onset_ticks", "peak_ticks", "recovery_ticks", "total_ticks", "elapsed")

    def __init__(self, atype: str, severity: str, onset: int, peak: int, recovery: int) -> None:
...
class AnomalyManager:
    def __init__(self) -> None:
        ...
        self._cooldown: int = random.randint(480, 2400)
        self._ticks: int = 0
        self._next_check: int = random.randint(480, 2400)
    ...
    def tick(self, allow_new: bool = True) -> None:
        ...
        if self.active is not None:
            ...
            if self.active.done:
                self.active = None
                self._cooldown = random.randint(480, 2400)
            return
        if self._cooldown > 0:
            self._cooldown -= 1
            return
        ...
        if self._ticks >= self._next_check:
            self._ticks = 0
            self._next_check = random.randint(480, 2400)
            if random.random() < 0.15:
                self._spawn()

    def _spawn(self) -> None:
        atype = random.choice(_ANOMALY_TYPES)
        severity = random.choices(["mild", "moderate", "severe"], weights=[78, 19, 3])[0]
        onset = random.randint(40, 100)
        peak = random.randint(20, 60)
        recovery = random.randint(60, 140)
        self.active = _AnomalySlot(atype, severity, onset, peak, recovery)

    def apply(self, state: dict) -> dict:
        if self.active is None:
            return state
        a, f = self.active, clamp(self.active.factor, 0.0, 1.0)
        targets_map = {"mild": 0, "moderate": 1, "severe": 2}
        si = targets_map[a.severity]

        if a.atype == "brake_pressure_drift":
            tgt = [395.0, 340.0, 290.0][si]
            state["brake_pipe_pressure_kpa"] = state["brake_pipe_pressure_kpa"] + (tgt - state["brake_pipe_pressure_kpa"]) * f
        elif a.atype == "leak_rate_increase":
            tgt = [22.0, 30.0, 36.0][si]
            state["brake_pipe_leak_kpa_per_min"] = state["brake_pipe_leak_kpa_per_min"] + (tgt - state["brake_pipe_leak_kpa_per_min"]) * f
        elif a.atype == "engine_overtemp":
            tgt = [102.0, 108.0, 113.0][si]
            ...
            if f > 0.5:
                state["comm_state"] = "intermittent" if a.severity != "severe" else "offline"
        elif a.atype == "alerter_timeout":
            if f > 0.3:
                tgt = [19.0, 22.0, 26.0][si]
                state["alerter_timer_sec"] = tgt * f
        elif a.atype == "eab_degradation":
            if f > 0.5:
                state["eab_status"] = "degraded" if a.severity != "severe" else "lost"
        return state
...
class LocomotiveRuntime:
    def __init__(self, config: dict, line: RailwayLine) -> None:
        ...
        self.train_run_id: str = str(uuid.uuid5(_LOCO_NS, f"{config['train_id']}:run"))
        ...
        self.route = RouteEngine(line, config["seg_idx"], config["seg_prog"], config["direction"])
        ...
        sl = line.speed_limits_data[min(config["seg_idx"], len(line.speed_limits_data) - 1)]
        ...
        self.locomotive_model = LocomotiveModel(
            locomotive_id=self.locomotive_id, serial_number=self.serial_number,
            line_id=self.line_id, line_name=self.line_name, created_at=self.created_at,
        )
        self.train_run_model = TrainRunModel(
            train_run_id=self.train_run_id, train_id=self.train_id,
            locomotive_id=self.locomotive_id, route_id=self.line_id,
            line_id=self.line_id, started_at=self.created_at,
        )
        self._emit_event("info", "system", "SIM_STARTED", f"Locomotive {self.serial_number} started on {self.line_name}")

    def _emit_event(self, severity: str, etype: str, code: str, message: str, payload: dict | None = None) -> None:
        self.event_log.append(EventLogEntry(
            event_id=str(uuid.uuid4()), ts=utcnow_iso(),
            locomotive_id=self.locomotive_id, line_id=self.line_id,
            severity=severity, event_type=etype, code=code, message=message,
            payload=payload or {},
        ).model_dump())
    ...
    def _update_mode(self) -> None:
        ...
        if self.mode in ("station_stop", "depot_stop", "idle_hold"):
            ...
            if self._station_timer >= self._station_wait_ticks:
                ...
                self._set_target()
                self._emit_event("info", "status", "DEPARTED_STATION", f"Departed from {self.route.next_waypoint_name()}", {"waypoint": self.route.next_waypoint_name()})
        ...
        if self.mode == "accelerating":
            ...
            if at_end and in_station and self.speed_kph < 2.0:
                ...
                self._emit_event("info", "status", "ARRIVED_STATION", f"Arrived at {wp}", {"waypoint": wp})
            elif in_slow and self.target_speed > 0 and self.speed_kph <= self.target_speed * 1.05:
                self.mode = "slow_zone"
    ...
    def _emit_mode_change(self, old: str) -> None:
        if self.mode != old:
            self._emit_event("info", "status", "MODE_CHANGED", f"Mode: {old} → {self.mode}", {"old_mode": old, "new_mode": self.mode})

    def _set_target(self) -> None:
        idx = self.route.segment_index
        sl = self.line.speed_limits_data[min(idx, len(self.line.speed_limits_data) - 1)]
    ...
    def _update_speed(self) -> None:
        if self.mode == "accelerating":
            self.speed_kph = min(self.target_speed, self.speed_kph + random.uniform(0.3, 0.8))
            self.throttle_pct = clamp(self.speed_kph / max(1.0, self.target_speed), 0, 1)
            self.brake_demand = 0.0
        elif self.mode in ("cruising", "slow_zone"):
            self.speed_kph = clamp(self.speed_kph + random.uniform(-0.12, 0.12), self.target_speed * 0.92, self.target_speed * 1.03)
            self.throttle_pct = clamp(0.30 + random.uniform(-0.05, 0.05), 0, 1)
            self.brake_demand = 0.0
        elif self.mode == "braking":
            self.speed_kph = max(0.0, self.speed_kph - random.uniform(0.5, 1.5))
            self.throttle_pct = 0.0
            self.brake_demand = clamp(1.0 - self.speed_kph / max(1.0, self.target_speed + 20), 0.0, 1.0) if self.target_speed > 0 else clamp(1.0 - self.speed_kph / 120.0, 0.3, 1.0)
        else:
            self.speed_kph = 0.0
            self.throttle_pct = 0.0
            self.brake_demand = 0.0
    ...
    def _update_engine(self) -> None:
        ...
        if self.mode == "accelerating":
            ...
            gf = clamp(1.0 + self.route.track_grade_pct() * 0.15, 0.5, 2.0)
            self.engine_rpm = jitter(lerp(600, 800, self.throttle_pct), 5)
            self.tractive_effort_kn = jitter(lerp(150, 300, self.throttle_pct) * gf, 5)
            self.traction_voltage_v = lerp(400, 800, self.throttle_pct)
            self.current_a = lerp(100, 500, self.throttle_pct)
            self.dynamic_brake_force_kn = 0.0
            self.fuel_consumption_rate_lph = jitter(lerp(150, 250, self.throttle_pct), 5)
            self.brake_cylinder_pressure_kpa = 0.0
            self.brake_status = "release"
        elif self.mode == "braking":
    ...
    def _update_thermal(self) -> None:
        tgt = {"station_stop": 75.0, "depot_stop": 75.0, "idle_hold": 75.0, "cruising": 88.0, "slow_zone": 86.0, "braking": 80.0}.get(self.mode, 88.0 + self.throttle_pct * 10.0)
    ...
    def _update_safety(self) -> None:
        ...
        if self._weather_tick <= 0:
            self.weather_factor = clamp(self.weather_factor + random.uniform(-0.01, 0.01), 0.85, 1.0)
            self._weather_tick = random.randint(60, 240)
        self._driver_tick -= 1
        if self._driver_tick <= 0:
            self._driver_tick = random.randint(600, 1200)
            self.driver_state["alertness"] = random.choices(["normal", "drowsy"], weights=[96, 4])[0]
    ...
    def tick(self, allow_new_anomaly: bool = True) -> dict:
        ...
        if seg_changed:
            self._emit_event("info", "status", "SEGMENT_CHANGED", f"Entered segment: {self.route.segment_name()}", {"segment": self.route.segment_name()})

        for gf in self.route.geofence_entered():
            c = "SLOW_ZONE_ENTER" if gf.type == "slow_zone" else "ENTER_GEOFENCE"
            self._emit_event("info", "geofence", c, f"Entered {gf.type}: {gf.name}", {"geofence": gf.name, "type": gf.type})
        for name in self.route.geofence_exited_names():
            self._emit_event("info", "geofence", "EXIT_GEOFENCE", f"Exited geofence: {name}", {"geofence": name})
        ...
        self.alarm_status, self.fault_codes = self.alert_engine.evaluate(state, self.event_log)
        ...
        self.current_state_snapshot = LocomotiveStateCurrent(
            locomotive_id=self.locomotive_id, serial_number=self.serial_number,
            train_id=self.train_id, line_id=self.line_id, line_name=self.line_name,
            updated_at=utcnow_iso(), last_ts=state["ts"],
            lat=state["lat"], lon=state["lon"], alt_m=state["alt_m"],
            speed_kph=state["speed_kph"], heading_deg=state["heading_deg"],
            brake_status=state["brake_status"], comm_state=state["comm_state"],
            eab_status=state["eab_status"], health_index=state["health_index"],
            alarm_status=state["alarm_status"], active_faults=state["fault_codes"],
            active_geofences=state["active_geofences"], current_mode=state["current_mode"],
            fuel_level_pct=state["fuel_level_pct"], engine_rpm=state["engine_rpm"],
            engine_temp_c=state["engine_temp_c"], direction=self.route.direction,
...
class FleetSimulator:
    ...
    def tick_all(self) -> list[dict]:
        self.global_seq += 1
        anom_count = sum(1 for rt in self.runtimes.values() if rt.anomaly_mgr.active is not None)
        results: list[dict] = []
        for lid in self._ordered_ids:
            rt = self.runtimes[lid]
            allow = anom_count < MAX_FLEET_ANOMALIES or rt.anomaly_mgr.active is not None
            state = rt.tick(allow_new_anomaly=allow)
            results.append(state)
            if rt.anomaly_mgr.active is not None:
                anom_count = sum(1 for r in self.runtimes.values() if r.anomaly_mgr.active is not None)
        return results
    ...
    def build_fleet_summary(self, runtimes: list[LocomotiveRuntime] | None = None) -> dict:
        rts = runtimes if runtimes is not None else self.all_runtimes()
        locos, warn_c, crit_c, active_c, stopped_c, total_hi = [], 0, 0, 0, 0, 0.0
        for rt in rts:
        ...
        for line_id, line in RAILWAY_LINES.items():
            ...
            l_active = sum(1 for r in l_rts if r.current_state_snapshot and r.current_state_snapshot["current_mode"] not in ("station_stop", "depot_stop", "idle_hold"))
            l_warn = sum(1 for r in l_rts if r.current_state_snapshot and r.current_state_snapshot["alarm_status"] == "warning")
            l_crit = sum(1 for r in l_rts if r.current_state_snapshot and r.current_state_snapshot["alarm_status"] == "critical")
            l_hi = [r.current_state_snapshot["health_index"] for r in l_rts if r.current_state_snapshot]
            line_summaries.append({
                "line_id": line_id, "name": line.name, "locomotive_count": len(l_rts),
                "active_count": l_active, "warning_count": l_warn, "critical_count": l_crit,
                "average_health_index": round(sum(l_hi) / max(1, len(l_hi)), 1),
            })
        return FleetSummary(
            total_locomotives=len(locos), active_count=active_c, stopped_count=stopped_c,
            warning_count=warn_c, critical_count=crit_c,
            average_health_index=round(total_hi / n, 1),
            lines=line_summaries, locomotives=locos,
        ).model_dump()
...
def _broadcast(state: dict) -> None:
    ...
    for cid, c in list(_ws_clients.items()):
        ...
        if c.locomotive_id is None and c.line_id is None:
            ...
            match = True
        elif c.line_id is not None and c.line_id == line_id and c.locomotive_id is None:
            match = True
        if match:
            try:
...
app = FastAPI(title="TE33A Multi-Line Fleet Telemetry Service", version="3.0.0")
...
async def list_lines() -> list[dict]:
    assert fleet is not None
    return [line.info_model(len(fleet.line_runtimes(line.line_id))) for line in RAILWAY_LINES.values()]
...
async def line_locos(line_id: str) -> list[dict]:
    assert fleet is not None
    _line_or_404(line_id)
    return [{"locomotive": rt.locomotive_model.model_dump(), "train_run": rt.train_run_model.model_dump()} for rt in fleet.line_runtimes(line_id)]
...
async def line_latest(line_id: str) -> list[dict]:
    assert fleet is not None
    _line_or_404(line_id)
    return [rt.latest_telemetry for rt in fleet.line_runtimes(line_id) if rt.latest_telemetry]


@app.get("/lines/{line_id}/events")
async def line_events(line_id: str, limit: int = Query(default=100, ge=1, le=5000)) -> list[dict]:
    assert fleet is not None
    _line_or_404(line_id)
    merged: list[dict] = []
...
async def fleet_latest() -> list[dict]:
    assert fleet is not None
    return [rt.latest_telemetry for rt in fleet.all_runtimes() if rt.latest_telemetry]


@app.get("/fleet/states")
async def fleet_states() -> list[dict]:
    assert fleet is not None
    return [rt.current_state_snapshot for rt in fleet.all_runtimes() if rt.current_state_snapshot]


@app.get("/fleet/events")
async def fleet_events(limit: int = Query(default=200, ge=1, le=10000)) -> list[dict]:
    assert fleet is not None
    merged: list[dict] = []
...
async def list_locos() -> list[dict]:
    assert fleet is not None
    return [{"locomotive": rt.locomotive_model.model_dump(), "train_run": rt.train_run_model.model_dump()} for rt in fleet.all_runtimes()]


@app.get("/locomotives/{locomotive_id}")
async def get_loco(locomotive_id: str) -> dict:
    rt = _rt_or_404(locomotive_id)
    return {"locomotive": rt.locomotive_model.model_dump(), "train_run": rt.train_run_model.model_dump()}
...
async def loco_history(locomotive_id: str, seconds: int = Query(default=300, ge=1, le=HISTORY_SECONDS)) -> list[dict]:
    rt = _rt_or_404(locomotive_id)
...
async def loco_events(locomotive_id: str, limit: int = Query(default=100, ge=1, le=5000)) -> list[dict]:
    rt = _rt_or_404(locomotive_id)
...
async def get_all_routes() -> list[dict]:
    return [
        {"line_id": line.line_id, "name": line.name, "waypoints": [w.model_dump() for w in line.waypoints],
         "speed_limits": [s.model_dump() for s in line.speed_limits], "geofences": [g.model_dump() for g in line.geofences],
...
async def route_progress(locomotive_id: str) -> dict:
    ...
    return RouteProgressModel(
        locomotive_id=rt.locomotive_id, line_id=rt.line_id,
        active_segment_index=r.segment_index, active_segment_name=r.segment_name(),
        direction=r.direction, segment_progress=round(r.segment_progress, 4),
        distance_to_next_waypoint_km=round(r.distance_to_next_wp_km, 2),
        next_waypoint_name=r.next_waypoint_name(),
        lat=round(r.lat, 6), lon=round(r.lon, 6), alt_m=round(r.alt_m, 1),
        heading_deg=round(r.heading_deg, 1), active_geofences=r.active_geofence_names(),
    ).model_dump()
...
async def ws_all(websocket: WebSocket) -> None:
    ...
    cid = id(websocket)
    _ws_clients[cid] = _WSClient(websocket, queue, locomotive_id=None, line_id=None)
    try:
...
async def ws_single(websocket: WebSocket, locomotive_id: str) -> None:
    ...
    queue: asyncio.Queue = asyncio.Queue(maxsize=WS_QUEUE_MAX)
    cid = id(websocket)
    _ws_clients[cid] = _WSClient(websocket, queue, locomotive_id=locomotive_id, line_id=None)
    try:
        await _ws_handler(websocket, queue)
    finally:
        _ws_clients.pop(cid, None)
...
async def ws_line(websocket: WebSocket, line_id: str) -> None:
    ...
    queue: asyncio.Queue = asyncio.Queue(maxsize=WS_QUEUE_MAX)
    cid = id(websocket)
    _ws_clients[cid] = _WSClient(websocket, queue, locomotive_id=None, line_id=line_id)
    try:
        await _ws_handler(websocket, queue)
    finally:
        _ws_clients.pop(cid, None)
